...
static int rk3066_num_entries __attribute__ ((section(".data")));

#define PMU_BASE	0x20004000
#define SPL_ENTRY	0x10081000
...
{
	/* Example code showing how to enable the debug UART on RK3066 */
#ifdef EARLY_UART
...
#define GRF_BASE	0x20008000
	...
	printch('l');
	printch('-');
	printhex8(rk3066_num_entries);
#endif
	rk3066_num_entries++;

	if (rk3066_num_entries == 1) {
		/*
		 ...
		 * at offset 0x1000 in the sram. Should never return
		 * from there.
		 */
		jump_to_spl();
	}
